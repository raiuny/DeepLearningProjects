...
def train_epoch(model, dataloader, writer, criterion, optimizer, scheduler, epoch, device):
    model.train()
    bar = tqdm(dataloader)
...
if __name__ == '__main__':
    ...
    for epoch in range(epoch_num):
        train_epoch(model, trainloader,trainwriter, criterion, optimizer, scheduler, epoch, device)
